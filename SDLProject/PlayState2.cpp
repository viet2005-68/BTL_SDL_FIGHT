...
bool PlayState2::onEnter() {
	...
	tower* newTower1 = new tower(new LoaderParams(1120, 650, 100, 140, "assets/tower.png"));
	tower* newTower2 = new tower(new LoaderParams(600, 650, 100, 140, "assets/tower.png"));
	m_towers.push_back(newTower);
	m_towers.push_back(newTower1);
	m_towers.push_back(newTower2);
